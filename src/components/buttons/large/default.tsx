...
export const ButtonLargeDefault = ({ text, loading, ...rest }: Props) => {
...
const Wrapper = styled.button<LoadingProps>(({ isLoading }) => [
  isLoading
    ? tw`
      flex-center px-24 py-12 bg-grayscale-6 rounded-8 font-sb-16 text-white relative non-clickable
    `
    : tw`
      flex-center px-24 py-12 bg-grayscale-6 rounded-8 font-sb-16 text-white relative
      enabled:hover:bg-white enabled:hover:shadow-button-hover enabled:hover:text-grayscale-7
