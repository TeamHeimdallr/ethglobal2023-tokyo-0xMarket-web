...
export const ButtonMediumPrimary = ({ text, loading, ...rest }: Props) => {
...
const Wrapper = styled.button<LoadingProps>(({ isLoading }) => [
  isLoading
    ? tw`
      flex-center px-20 py-9 bg-blue rounded-8 font-sb-14 text-white relative non-clickable
    `
    : tw`
      flex-center px-20 py-9 bg-blue rounded-8 font-sb-14 text-white relative
