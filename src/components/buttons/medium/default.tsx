...
export const ButtonMediumDefault = ({ text, loading, ...rest }: Props) => {
...
const Wrapper = styled.button<LoadingProps>(({ isLoading }) => [
  isLoading
    ? tw`
      flex-center px-20 py-9 bg-grayscale-6 rounded-8 font-sb-14 text-white relative non-clickable
    `
    : tw`
      flex-center px-20 py-9 bg-grayscale-6 rounded-8 font-sb-14 text-white relative
