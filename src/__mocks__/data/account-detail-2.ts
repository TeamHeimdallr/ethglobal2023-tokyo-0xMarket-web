...
export const accountDetail: Account = {
  ...
  title: '[50,000] 6 Month vesting left wallet for TOKYO token. Monthly drop',
  description:
    'This account is a account to receive TOKYO token vesting from the angel investment a year ago.\n' +
    'We have received 100,000 TOKYO untill now and waiting for the next drop in April 28th, 2023.\n' +
